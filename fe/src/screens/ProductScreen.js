        ...
        <Row style={{marginTop: "30px"}}>
              <Col md={6}>
                  ...
                  <ListGroup variant='flush'>
                      ...
                      <ListGroup.Item>
                          <h4 style={{marginTop: "20px"}}>viết Đánh giá</h4>
                          ...
                          {userInfo ? (
                              <Form onSubmit={submitHandler}>
                                  <Form.Group controlId='rating'>
                                      <Form.Label style={{marginTop: "10px"}}>Chất lượng sản phẩm</Form.Label>
                                      <Form.Control
                                  ...
                                  <Form.Group controlId='comment'>
                                      <Form.Label style={{marginTop: "10px"}}>Nhận xét</Form.Label>
                                      <Form.Control
                                          style={{marginTop: "10px"}}
                                          as='textarea'
                                          row='5'
